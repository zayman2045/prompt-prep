...
export function ChallengeGeneratorForm() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-purple-900 to-blue-900 border-pink-700 p-4">
      ...
      {/* Generate Button */}
      <div className="bg-gradient-to-r from-purple-900 to-blue-900 p-4 flex justify-center border-pink-700 border-t-2">
